...
in {
  ...
  in {
    # NOTE: plaintext placeholder, replaced with a sops secret in Phase 5.
    ...
    systemd.services.n8n.serviceConfig = {
      Users = top.flake.user.name; # NOTE: preserved verbatim; systemd's key is `User` — looks like a latent typo
      Group = "users";
